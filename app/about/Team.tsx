...
const Team = () => {
  return (
    <section className="mx-auto my-8 max-w-5xl">
      ...
      <div className="mx-auto mb-8 flex max-w-2xl flex-col items-center justify-between gap-4 md:flex-row md:gap-0">
        {CORE_TEAM.map((member) => (
          <TeamMemberCard key={member.name} {...member} />
        ))}
      </div>
      <div className="flex max-w-5xl flex-col items-center justify-between gap-4 md:flex-row md:gap-0">
